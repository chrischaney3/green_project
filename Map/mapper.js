...
var mapCenter = [38.147853, -98.612973];
...
function createMarkers(data) {
  for (var i = 0; i < data.length; i++) {
    ...
    /*if (station["Groups With Access Code"] == "Public - see hours") {
...
var layer2012 = L.heatLayer(markers2012, {
  radius: 100,
  blur: 30
});
var layer2014 = L.heatLayer(markers2014, {
  radius: 100,
  blur: 30
});
var layer2021 = L.heatLayer(markers2021, {
  radius: 100,
  blur: 30
})
